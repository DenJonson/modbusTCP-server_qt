...
void ModbusServer::sendData() {
  ...
  //  m_requestStream.setDevice(clientConnection);
  //  QString request;
  //  m_requestStream.startTransaction();
  //  m_requestStream >> request;

  //  QByteArray incommingData = clientConnection->read(16);
  //  QDataStream in(&incommingData, QIODevice::ReadOnly);
  //  QString request;
  //  in >> request;

  //  auto request = clientConnection->readData()

  QDataStream requestStream;
  requestStream.setDevice(clientConnection);
